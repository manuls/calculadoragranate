...
Estado actual:
- La clasificación base de la app ya incorpora los resultados oficiales hasta la jornada 1 de la temporada 2026/27.
- Por eso, ambos JSON deben mantenerse vacíos hasta que se quieran registrar jornadas posteriores a la 1.
